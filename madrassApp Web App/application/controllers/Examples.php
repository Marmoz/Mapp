...
public function dakhla($idEtudiant)
	{
		$data = array(
            'metaTitle' => 'Ajouter compte Etudiant | MadrassApp App',
...
$data = array(
	...
	{
		$data = array(
            'metaTitle' => 'Ajouter compte Enseignant | MadrassApp App',
...
$data = array(
	...
	{
		$data = array(
            'metaTitle' => 'Accueil | MadrassApp App',	);
...
echo $this->load->view('template/footer', '', TRUE);
	...
	public function login()
	{
		...
		$data = array(
            'metaTitle' => 'Connectez vous | MadrassApp App',
		);
