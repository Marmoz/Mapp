...
$config['default_login_redirect'] = 'examples/home';
...
$config['allowed_pages_for_login'] = ["examples/optional_login_test", "examples/ajax_attempt_login"];
